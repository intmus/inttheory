...
**Scales/Collections:**
- Both refer to any group of five or more notes, that can be ordered in a repeating ascending/descending pattern.
- A *scale* is a collection that has a defined tonic
