...
**NOTE #1: This piece has multiple modulations that I have marked into the score. We will cover modulations in a later unit, but for now, make sure to analyze each phrase ending in the correct key. If you do not, your cadences will not make sense.**

**NOTE #2: There are a few pitches which are not part functionally part of the chords in these cadences, so you should exclude them from your analysis. We will discuss non-chord tones in detail in the following unit. Please ignore all four pitches labeled as "NCT" in this example, but for clarity, these include:**
- The A in the second system, measure 6, trebel clef
- The A in the fourth system, measure 4, treble clef
- The D in the fifth system, measure 5, treble clef
- The B-flat in the fifth system, measure 6, treble clef
