---
layout: chapter
title: 22e Discussion - PC Set Prime Form
abc: true
---
...
### Prime Form
- A zeroed-out representation of all the transpositions and inversions of a single PC set.
- In simple terms, **prime form is just normal form transposed to 0.**
- Prime form is useful for making PC sets easy to compare with other PC sets. 
- Written with *curved parentheses* and *no commas*.
- Ex: (036)

**"What is a Set Class?"**
- Set Class is short for **Pitch Class Set Class**
- It is a group of Pitch Class Sets that are *related by transposition or inversion*.
- Prime Form is a way of representing a Set Class

### Practice Example

**Put (5,3,8,t) into prime form.**

**Step 1 - Ascending Forms:**
- (5,3,8,t) becomes **(3,5,8,t)** or **(5,8,t,3)** or **(8,t,3,5)** or **(t,3,5,8)**

**Step 2 - Normal Form:**
- the ascending form with the smallest outer interval is **[3,5,8,t]**

**Step 3 - Prime Form:**
- [3,5,8,t] becomes **(0257)**
