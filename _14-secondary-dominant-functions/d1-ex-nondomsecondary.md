...
That being said, just because you can label something in a complex way does not mean that this is helpful in your analysis. Roman numeral analysis is at its best when analyzing diatonic function, so you should always prioritize the current key in your analysis. This will become even more important when we discuss modulation in the next unit. (Unit 15) 

And if you still want to label this as a secondary chord, please remember that the simplest explanation is usually the best. Analysis is meant to demonstrate how music works, and most listeners aren't aware of movement between two keys. In this example, I highly recommend that you label this as a vi chord in C major--exactly as you would have before you learned of tonicization. Exploring secondary funtion is an excellent way to illustrate the voice-leading foundations that drive harmonic progression, but complexity for complexity's sake does not help explain how an average listener hears music, which should always be your goal when analyzing a piece. 